...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ftc2.autoresize.listener' => 'getFtc2_Autoresize_ListenerService',
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('ftc2.autoresize.listener', 'ftc2\\autoresize\\event\\main_listener');
    ...
    /**
     * Gets the public 'ftc2.autoresize.listener' shared service.
     *
     * @return \ftc2\autoresize\event\main_listener
     */
    protected function getFtc2_Autoresize_ListenerService()
    {
        return $this->services['ftc2.autoresize.listener'] = new \ftc2\autoresize\event\main_listener($this->get('config'), $this->get('user'));
    }

    /**
     * Gets the public 'gfksx.thanksforposts.controller.thankslist' shared service.
     *
     * @return \gfksx\ThanksForPosts\controller\thankslist
     */
    protected function getGfksx_Thanksforposts_Controller_ThankslistService()
    {
        return $this->services['gfksx.thanksforposts.controller.thankslist'] = new \gfksx\ThanksForPosts\controller\thankslist($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('cache.driver'), $this->get('pagination'), $this->get('profilefields.manager'), $this->get('request'), $this->get('controller.helper'), 'bb_thanks', 'bb_users', './../', 'php');
    }

    /**
     * Gets the public 'gfksx.thanksforposts.controller.toplist' shared service.
     *
     * @return \gfksx\ThanksForPosts\controller\toplist
     */
    protected function getGfksx_Thanksforposts_Controller_ToplistService()
    {
        return $this->services['gfksx.thanksforposts.controller.toplist'] = new \gfksx\ThanksForPosts\controller\toplist($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('cache.driver'), './../', 'php', $this->get('pagination'), $this->get('gfksx.thanksforposts.helper'), $this->get('request'), $this->get('controller.helper'), 'bb_thanks', 'bb_users', 'bb_posts');
    }

    /**
     * Gets the public 'gfksx.thanksforposts.helper' shared service.
     *
     * @return \gfksx\ThanksForPosts\core\helper
     */
    protected function getGfksx_Thanksforposts_HelperService()
    {
        return $this->services['gfksx.thanksforposts.helper'] = new \gfksx\ThanksForPosts\core\helper($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('cache.driver'), $this->get('request'), $this->get('notification_manager'), $this->get('controller.helper'), $this->get('dispatcher'), './../', 'php', 'bb_', 'bb_thanks', 'bb_users', 'bb_posts', 'bb_notifications');
    }

    /**
     * Gets the public 'gfksx.thanksforposts.listener' shared service.
     *
     * @return \gfksx\ThanksForPosts\event\listener
     */
    ...
    /**
     * Gets the public 'gfksx.thanksforposts.notification.type.thanks' service.
     *
     * @return \gfksx\ThanksForPosts\notification\thanks
     */
    protected function getGfksx_Thanksforposts_Notification_Type_ThanksService()
    {
        return new \gfksx\ThanksForPosts\notification\thanks($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bb_user_notifications', 'bb_notifications', $this->get('user_loader'));
    }

    /**
     * Gets the public 'gfksx.thanksforposts.notification.type.thanks_remove' service.
     *
     * @return \gfksx\ThanksForPosts\notification\thanks_remove
     */
    protected function getGfksx_Thanksforposts_Notification_Type_ThanksRemoveService()
    {
        return new \gfksx\ThanksForPosts\notification\thanks_remove($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bb_user_notifications', 'bb_notifications', $this->get('user_loader'));
    }
    ...
    {
        $instance = new \paul999\mention\notification\type\mention($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bb_user_notifications');
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006d4835620000000002bd00de(
...
class phpbbtemplatetwiglexer_000000006d4835620000000002bd00de extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d72deb274c5d877337007 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d72deb274c79104157256 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d72deb274c0d167666263 = array(
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, 'set_environment', array('env' => $env), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        return $this->valueHolder5d72deb274c5d877337007->set_environment($env);
    }
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        return $this->valueHolder5d72deb274c5d877337007->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        return $this->valueHolder5d72deb274c5d877337007->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d72deb274c79104157256 = $initializer;
    }
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__get', array('name' => $name), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        if (isset(self::$publicProperties5d72deb274c0d167666263[$name])) {
            return $this->valueHolder5d72deb274c5d877337007->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d72deb274c5d877337007;
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__isset', array('name' => $name), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__unset', array('name' => $name), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;
    ...
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__clone', array(), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        $this->valueHolder5d72deb274c5d877337007 = clone $this->valueHolder5d72deb274c5d877337007;
    }

    public function __sleep()
    {
        $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, '__sleep', array(), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;

        return array('valueHolder5d72deb274c5d877337007');
    }
    ...
    {
        return $this->initializer5d72deb274c79104157256;
    }
    ...
    {
        return $this->initializer5d72deb274c79104157256 && ($this->initializer5d72deb274c79104157256->__invoke($valueHolder5d72deb274c5d877337007, $this, 'initializeProxy', array(), $this->initializer5d72deb274c79104157256) || 1) && $this->valueHolder5d72deb274c5d877337007 = $valueHolder5d72deb274c5d877337007;
    }
    ...
    {
        return null !== $this->valueHolder5d72deb274c5d877337007;
    }
    ...
    {
        return $this->valueHolder5d72deb274c5d877337007;
    }
