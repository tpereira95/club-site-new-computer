...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000054139336000000000319b4bc(
...
class phpbbtemplatetwiglexer_0000000054139336000000000319b4bc extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b68aef607aac233344240 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b68aef607aca826264144 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b68aef607a58403877479 = array(
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, 'set_environment', array('env' => $env), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        return $this->valueHolder5b68aef607aac233344240->set_environment($env);
    }
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        return $this->valueHolder5b68aef607aac233344240->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        return $this->valueHolder5b68aef607aac233344240->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b68aef607aca826264144 = $initializer;
    }
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__get', array('name' => $name), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        if (isset(self::$publicProperties5b68aef607a58403877479[$name])) {
            return $this->valueHolder5b68aef607aac233344240->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b68aef607aac233344240;
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__isset', array('name' => $name), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__unset', array('name' => $name), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;
    ...
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__clone', array(), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        $this->valueHolder5b68aef607aac233344240 = clone $this->valueHolder5b68aef607aac233344240;
    }

    public function __sleep()
    {
        $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, '__sleep', array(), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;

        return array('valueHolder5b68aef607aac233344240');
    }
    ...
    {
        return $this->initializer5b68aef607aca826264144;
    }
    ...
    {
        return $this->initializer5b68aef607aca826264144 && ($this->initializer5b68aef607aca826264144->__invoke($valueHolder5b68aef607aac233344240, $this, 'initializeProxy', array(), $this->initializer5b68aef607aca826264144) || 1) && $this->valueHolder5b68aef607aac233344240 = $valueHolder5b68aef607aac233344240;
    }
    ...
    {
        return null !== $this->valueHolder5b68aef607aac233344240;
    }
    ...
    {
        return $this->valueHolder5b68aef607aac233344240;
    }
